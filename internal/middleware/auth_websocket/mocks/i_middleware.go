...
// AuthWebSocketMiddleware provides a mock function with given fields: c
func (_m *IMiddleware) AuthWebSocketMiddleware(c fiber.Ctx) error {
	ret := _m.Called(c)

	if len(ret) == 0 {
		panic("no return value specified for AuthWebSocketMiddleware")
	}
