...
import (
	...
	createnotifications "github.com/go-jedi/lingramm_backend/internal/repository/v1/notification/create_notifications"
...
type Repository struct {
	...
	CreateNotifications          createnotifications.ICreateNotifications
...
func New(
	...
	return &Repository{
		...
		CreateNotifications:          createnotifications.New(queryTimeout, logger),
