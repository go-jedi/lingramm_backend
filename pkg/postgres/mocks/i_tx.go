...
func (_m *ITx) Begin(ctx context.Context) (pgx.Tx, error) {
	ret := _m.Called(ctx)
...
func (_m *ITx) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_m *ITx) Exec(ctx context.Context, sql string, arguments ...interface{}) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
func (_m *ITx) LargeObjects() pgx.LargeObjects {
	ret := _m.Called()
...
func (_m *ITx) Prepare(ctx context.Context, name string, sql string) (*pgconn.StatementDescription, error) {
...
func (_m *ITx) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *ITx) QueryRow(ctx context.Context, sql string, args ...interface{}) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *ITx) SendBatch(ctx context.Context, b *pgx.Batch) pgx.BatchResults {
	ret := _m.Called(ctx, b)
