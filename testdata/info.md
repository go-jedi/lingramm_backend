...
- `migrate create -ext sql -dir migrations -seq notifications_create_function`
...
- `migrate -database postgresql://admin:test@localhost:54320/lingramm_db?sslmode=disable -path migrations up`
- `migrate -database postgresql://admin:test@localhost:54320/lingramm_db?sslmode=disable -path migrations down`
