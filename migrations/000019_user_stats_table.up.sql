CREATE TABLE IF NOT EXISTS user_stats ( -- Хранение прогресса пользователя.
    ...
    daily_task_streak_days BIGINT NOT NULL DEFAULT 0, -- Сколько дней подряд пользователь выполнил ежедневных заданий.
    last_daily_task_streak_days BIGINT NOT NULL DEFAULT 0, -- Дата последнего выполненного ежедневного задания пользователем.
